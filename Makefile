...
ALL			+= util-vserver
util-vserver-URL       := http://build.planet-lab.org/third-party/util-vserver-0.30.216-pre2913.tar.bz2
util-vserver-SHA1SUM   := a52b6cdc7137c8807a7b6e69836e6a0298c7e1f6
